...
# and simulation snapshot
    ...
    def COM_P(self, delta):
        ...
        r_COM = (x_COM**2+y_COM**2+z_COM**2)**.5
        ...
        y_new = self.y-y_COM
        z_new = self.z-z_COM
        r_new = (x_new**2+y_new**2+z_new**2)**.5
        ...
        while (change > delta):
            ...
            # write your own code below
            r_COM2 = (x_COM2**2+y_COM2**2+z_COM2**2)**.5
